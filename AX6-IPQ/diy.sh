...
# 1. 彻底清除冲突目录
rm -rf package/luci-theme-argon package/luci-app-argon-config package/small package/openwrt-packages package/daed package/dae package/luci-app-nikki package/luci-app-daed
